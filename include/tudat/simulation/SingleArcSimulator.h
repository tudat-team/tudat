...
namespace tudat {
    ...
    namespace numerical_simulation {
        ...
        public:
            ...
            using IntegratorType = std::shared_ptr< numerical_integrators::NumericalIntegrator< TimeType, StateType, StateType, TimeStepType > >;
            using StopPropagationFunctionType = std::function< bool( const double, const double ) >;
            ...
            SingleArcSimulator(
                    ...
                    propagatorSettings_(std::dynamic_pointer_cast<SingleArcPropagatorSettings<StateScalarType>>(
                            propagatorSettings)),
                ...
                if (propagatorSettings == nullptr) {
                    throw std::runtime_error("Error in dynamics simulator, propagator settings not defined.");
                        ...
                        std::dynamic_pointer_cast<SingleArcPropagatorSettings<StateScalarType> >
                                (propagatorSettings) ==
                        nullptr) {
                ...
                if (stateDerivativeModels.size() == 0) {
                    dynamicsStateDerivative_ =
                            std::make_shared<DynamicsStateDerivativeModel<TimeType, StateScalarType> >(
                ...
                propagationTerminationCondition_ = createPropagationTerminationConditions(
                        propagatorSettings_->getTerminationSettings(),
                        bodies_,
                ...
                doubleStateDerivativeFunction_ =
                        std::bind(
                                &DynamicsStateDerivativeModel<TimeType, StateScalarType>::computeStateDoubleDerivative,
                                dynamicsStateDerivative_,
                                std::placeholders::_1,
                                std::placeholders::_2);
...
//                }
            ...
            SingleArcSimulator(
                    ...
                    SingleArcSimulator(bodies, integratorSettings, propagatorSettings,
...
//                        propagatorSettings_->getInitialStates(), this->initialPropagationTime_ );
                ...
                integrationInterface_ = std::make_shared<IntegrationInterface<StateScalarType, StateType, TimeType, TimeStepType>>(
                        integrator_,
            ...
            bool isTerminal() {
                return integrationInterface_->isTerminal();
            }
                ...
                propagationTerminationReason_ =
                        EquationIntegrationInterface<StateType, TimeType>::integrateEquations(
                                ...
                                dynamicsStateDerivative_->convertFromOutputSolution(
                                        propagatorSettings_->getInitialStates(), this->initialPropagationTime_), integratorSettings_,
                                propagationTerminationCondition_,
                                dependentVariableHistory_,
                                cumulativeComputationTimeHistory_,
                                dependentVariablesFunctions_,
            ...
            std::function<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
                    (const double, const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> &)>
        ...
        protected:
            ...
            std::shared_ptr<IntegrationInterface<StateScalarType, StateType, TimeType, TimeStepType>> integrationInterface_;
            ...
            std::function<Eigen::Matrix<StateScalarType, Eigen::Dynamic, Eigen::Dynamic>
                    (const TimeType,
                     const Eigen::Matrix<StateScalarType, Eigen::Dynamic, Eigen::Dynamic> &)> stateDerivativeFunction_;
            ...
            std::function<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
                    (const double,
                     const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> &)> doubleStateDerivativeFunction_;
