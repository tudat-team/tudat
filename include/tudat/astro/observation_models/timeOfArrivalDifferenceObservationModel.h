...
#ifndef TUDAT_TIMEOFARRIVALDIFFERENCEOBSERVATIONMODEL_H
#define TUDAT_TIMEOFARRIVALDIFFERENCEOBSERVATIONMODEL_H
...
class TimeOfArrivalDifferenceObservationModel: public ObservationModel< 1, ObservationScalarType, TimeType >
{
public:
    ...
    /*!
     *  Constructor,
     *  \param lightTimeCalculatorFirstReceiver Object to compute the light-time (including any corrections w.r.t. Euclidean case)
     *  between source and first receiver
     *  \param lightTimeCalculatorSecondReceiver Object to compute the light-time (including any corrections w.r.t. Euclidean case)
     *  between source and second receiver
     *  \param observationBiasCalculator Object for calculating system-dependent errors in the
     *  observable, i.e. deviations from the physically ideal observable between reference points (default none).
     */
    TimeOfArrivalDifferenceObservationModel(
            const LinkEnds linkEnds,
            const std::shared_ptr< observation_models::LightTimeCalculator< ObservationScalarType, TimeType > > lightTimeCalculatorFirstReceiver,
            const std::shared_ptr< observation_models::LightTimeCalculator< ObservationScalarType, TimeType > > lightTimeCalculatorSecondReceiver,
        ...
        lightTimeCalculatorFirstReceiver_( lightTimeCalculatorFirstReceiver ), lightTimeCalculatorSecondReceiver_( lightTimeCalculatorSecondReceiver ) { }
...

    {
        ...
        {
        case transmitter:
            lightTimeFirstReceiver = lightTimeCalculatorFirstReceiver_->calculateLightTimeWithLinkEndsStates(
                firstReceiverState, transmitterState, time, false, ancilliarySetings );
            lightTimeSecondReceiver = lightTimeCalculatorSecondReceiver_->calculateLightTimeWithLinkEndsStates(
     ...
     */
    std::shared_ptr< observation_models::LightTimeCalculator< ObservationScalarType, TimeType > > getLightTimeCalculatorFirstReceiver( )
    {
        return lightTimeCalculatorFirstReceiver_;
    }
     ...
     */
    std::shared_ptr< observation_models::LightTimeCalculator< ObservationScalarType, TimeType > > getLightTimeCalculatorSecondReceiver( )
    {
        return lightTimeCalculatorSecondReceiver_;
    }
...
private:
     ...
     */
    std::shared_ptr< observation_models::LightTimeCalculator< ObservationScalarType, TimeType > > lightTimeCalculatorFirstReceiver_;
     ...
     */
    std::shared_ptr< observation_models::LightTimeCalculator< ObservationScalarType, TimeType > > lightTimeCalculatorSecondReceiver_;
};
...
#endif // TUDAT_TIMEOFARRIVALDIFFERENCEOBSERVATIONMODEL_H
