...
double evaluatePolynomialSquareRootSumMichael( const std::map< double, double >& amplitudesAtUnitFrequencyPerPower, const std::vector<double> frequencyNodes, const double frequency )
{
...
{
    return generateAmplitudeSpectrumNoise( maximumFrequency, numberOfFrequencySamples,
                                           std::bind( &evaluatePolynomialSquareRootSumMichael, powersAndUnitAmplitudes, frequencyNodes, std::placeholders::_1 ), seed );
}
