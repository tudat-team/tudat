...
//! Function to generate clock noise for a clock with given allan variance behaviour
std::pair< std::vector< double >, double > generateClockNoiseMichael( const std::map< int, double > allanVarianceNodes,
                                                               const std::string& varianceType,
                                                               const double startTime, const double endTime,
                                                               const int numberOfTimeSteps, const bool isInverseSquareTermFlickerPhaseNoise,
                                                               const double seed )
{
    ...
    // Convert time domain amplitudes to frequency domain amplitudes.
    std::pair< std::map<double, double>, std::vector<double> > dummy = convertAllanVarianceAmplitudesToPhaseNoiseAmplitudesMichael( allanVarianceAmplitudes, varianceType );
                                                  ...
                                                  const double timeStep, const double seed )
{
    ...
    std::pair< std::vector< double >, double > clockNoise = generateClockNoiseMichael(
...
std::function< double( const double ) > getClockNoiseInterpolatorMichael(
        ...
        const double timeStep, const double seed)
        {
            std::map< double, double > clockNoiseMap = generateClockNoiseMapMichael( allanVarianceNodes, varianceType, startTime, endTime, timeStep , seed );
